    ...
    <div className="px-6 py-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <FadeInUp className="text-center mb-16">
          <h1 className="text-4xl md:text-6xl font-['Playfair_Display'] font-bold mb-6 bg-gradient-to-r from-[#D4AF37] to-[#FFD777] bg-clip-text text-transparent glow-text pb-2 leading-[1.3]">
        ...
        <FadeInUp delay={100} className="mb-20">
          <div className="bg-gradient-to-br from-[#D4AF37]/10 to-[#FFD777]/5 border border-[#D4AF37]/20 rounded-3xl p-12 text-center backdrop-blur-sm hover:shadow-2xl hover:shadow-[#D4AF37]/20 transition-all duration-400 living-card">
          ...
          <div className="bg-[#ECE8E3]/5 border border-[#ECE8E3]/10 rounded-3xl p-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-br from-[#D4AF37]/10 to-[#FFD777]/5 rounded-2xl p-8 border border-[#D4AF37]/20">
                ...
                <button className="reward-button btn-reward-instant shimmer-hover w-full mt-8 px-6 py-4 bg-gradient-to-r from-[#D4AF37] to-[#FFD777] text-[#08070A] font-bold text-lg rounded-xl">
                  Apply for Credit
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {creditFeatures.map((feature, index) => (
              <FadeInUp key={index} delay={700 + index * 100}>
                <div className="group p-8 bg-[#ECE8E3]/5 border border-[#ECE8E3]/10 rounded-2xl hover:border-[#D4AF37]/30 transition-all duration-300 hover:shadow-xl hover:shadow-[#D4AF37]/10 hover:-translate-y-2 living-card">
