        ...
        <FadeInUp delay={100} className="mb-8">
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            <div className="flex-1 max-w-md relative">
              <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-[#ECE8E3]/50 living-icon" />
              <input
                type="text"
                placeholder="Search products, manufacturers..."
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full pl-10 pr-4 py-3 bg-[#ECE8E3]/10 border-2 border-[#ECE8E3]/30 rounded-lg focus:border-[#D4AF37] focus:outline-none focus:ring-2 focus:ring-[#D4AF37]/20 text-[#ECE8E3] placeholder-[#ECE8E3]/50 transition-all duration-200 living-card"
              />
            </div>
                    ...
                    <div className="p-6 flex-1">
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <div className="flex items-center text-sm text-[#ECE8E3]/60">
                          <Star className="w-4 h-4 text-[#D4AF37] mr-1 living-icon" />
