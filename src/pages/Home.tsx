  ...
  return (
    <div className="relative text-[#ECE8E3] bg-[#08070A] overflow-x-hidden">
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
         <FadeInUp className="text-center mb-16">
  <h2 className="text-4xl md:text-5xl font-['Playfair_Display'] font-bold mb-8 tracking-wide
                 bg-gradient-to-r from-[#D4AF37] to-[#FFD777] bg-clip-text text-transparent
                 leading-[1.3] pb-2">
